...
int main()
{
	...
	// Switch octree buffers: This resets octree but keep previous tree structure in memory.
	...
	// Get vector of point indices from octree voxels (based on cloudB) which did not exist in previous buffer (based on cloudA)
